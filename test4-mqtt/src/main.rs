...
fn main() {
    ...
    channel_filters.push((TopicFilter::new("#").unwrap(), QualityOfService::Level0) );
        ...
        match packet {
            ...
            VariablePacket::PublishPacket(ref publ) => {
                ...
                let unwrapped = match parsed {
                    ...
                    Err(_err) => json::JsonValue::from(msg)
                };
                info!("{} ---  {}", publ.topic_name(), unwrapped.pretty(2));
            }
            _ => {}
        }
    }
